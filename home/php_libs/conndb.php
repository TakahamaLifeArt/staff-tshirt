...
class Conndb extends HTTP {
	...
	*	@return			[商品情報]
	*/
	public function itemOf($id, $tag=null, $mode="category", $limit=null){
		$res = parent::request('POST', array('act'=>'itemof', 'id'=>$id, 'tag'=>$tag, 'mode'=>$mode, 'limit'=>$limit,'show_site'=>_SITE));
		$data = unserialize($res);
